  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm">
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-purple-50 flex">
        {/* Sidebar */}
        <div className="w-80 bg-white shadow-2xl border-r border-purple-100">
          {/* Header */}
          <div className="p-6 border-b border-purple-100 bg-gradient-to-r from-pink-500 to-purple-600">
          ...
          <div className="p-4">
            ...
            {activeSection === 'portfolio' && (
              <div className="mt-6">
                <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-3">Portfolio Categories</h3>
            ...
            <div className="mt-8 pt-6 border-t border-purple-100">
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl hover:shadow-lg transition-all duration-200"
                >
                ...
                <button
                  onClick={exportData}
                  className="w-full flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl hover:shadow-lg transition-all duration-200"
                >
